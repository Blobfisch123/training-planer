...
const EXERCISES = [
  ...
  // Brust (neu)
  { id:'e43', name:'KH Bankdrücken (flach)', cat:'Brust',     eq:'Kurzhantel',    muscles:['Brust','Schulter','Trizeps'],            riskParts:['Schulter'],              desc:'Lege dich auf eine flache Bank, je eine Kurzhantel auf Brusthöhe. Drücke die Hanteln nach oben und führe sie am höchsten Punkt leicht zusammen. Die Kurzhanteln erlauben eine tiefere Absenkung als die Langhantel – bessere Dehnung für die Brust.' },
  { id:'e44', name:'Pec Deck / Butterfly',   cat:'Brust',     eq:'Maschine',      muscles:['Brust'],                                riskParts:['Schulter'],              desc:'Setze dich an die Maschine, Unterarme an den Pads. Führe die Arme vor dem Körper zusammen und öffne sie kontrolliert wieder. Rücken bleibt am Polster. Ideal zur Isolation der inneren Brust und für einen starken Pump.' },
  // Rücken (neu)
  { id:'e45', name:'Einarmiges KH-Rudern',   cat:'Rücken',    eq:'Kurzhantel',    muscles:['Latissimus','Mittlerer Rücken','Bizeps'], riskParts:['Rücken'],               desc:'Stütze eine Hand und das gleichseitige Knie auf einer Bank. Ziehe die Kurzhantel mit der freien Hand zur Hüfte – Ellenbogen nah am Körper, Schulterblatt am Endpunkt einziehen. Rücken gerade und parallel zum Boden halten.' },
  // Beine (neu)
  { id:'e46', name:'Hip Thrust / Glute Bridge', cat:'Beine',  eq:'Langhantel',    muscles:['Gesäß','Hamstrings'],                   riskParts:['Rücken'],                desc:'Lehne den Oberkörper gegen eine Bank, Langhantel über die Hüfte gelegt. Drücke die Hüfte explosiv nach oben bis Körper und Oberschenkel eine gerade Linie bilden. Gesäß am höchsten Punkt maximal anspannen, kontrolliert absenken.' },
  { id:'e47', name:'Goblet Squat',            cat:'Beine',    eq:'Kurzhantel',    muscles:['Quadrizeps','Gesäß'],                   riskParts:['Knie'],                  desc:'Halte eine Kurzhantel mit beiden Händen vor der Brust wie einen Kelch. Senke dich tief in die Kniebeuge ab, Ellenbogen zwischen die Knie drücken. Fördert aufrechte Haltung und gute Tiefe – ideal als Einsteiger- und Technikübung.' },
  { id:'e48', name:'Step-Ups',                cat:'Beine',    eq:'Kurzhantel',    muscles:['Quadrizeps','Gesäß'],                   riskParts:['Knie','Hüfte'],          desc:'Stehe vor einer Erhöhung (Stufe, Bank oder Box). Steige mit einem Fuß auf die Erhöhung, ziehe das andere Bein nach. Kontrolliert wieder hinuntersteigen. Wechselweise ausführen. Kurzhanteln für mehr Widerstand hinzunehmen.' },
  // Bizeps (neu)
  { id:'e49', name:'Scottcurl (Preacher Curl)', cat:'Bizeps', eq:'Langhantel',    muscles:['Bizeps'],                               riskParts:['Ellenbogen'],            desc:'Lege die Oberarme auf das geneigte Stützpolster der Scott-Bank. Beuge die Ellenbogen und führe die Stange zur Schulter. Die Stütze verhindert Schwung und erzwingt maximale Bizeps-Isolation – besonders wirksam für den unteren Bizepskopf.' },
  { id:'e50', name:'Reverse Curl',             cat:'Bizeps',  eq:'Langhantel',    muscles:['Bizeps','Unterarm','Brachialis'],        riskParts:['Ellenbogen'],            desc:'Halte die Langhantel mit Überhandgriff (Handrücken nach oben). Beuge die Ellenbogen wie beim normalen Curl und führe die Stange zur Schulter. Der umgekehrte Griff betont Brachialis und Unterarme deutlich stärker.' },
  // Trizeps (neu)
  { id:'e51', name:'Close-Grip Bankdrücken',   cat:'Trizeps', eq:'Langhantel',    muscles:['Trizeps','Brust'],                      riskParts:['Ellenbogen','Schulter'], desc:'Bankdrücken mit engem Griff (ca. schulterbreit oder etwas enger). Ellenbogen nah am Körper lassen beim Absenken. Die enge Griffweite verlagert den Fokus von der Brust fast vollständig auf den Trizeps.' },
  { id:'e52', name:'Trizeps Kickback',         cat:'Trizeps', eq:'Kurzhantel',    muscles:['Trizeps'],                              riskParts:['Ellenbogen'],            desc:'Beuge den Oberkörper nach vorne und stütze eine Hand auf einer Bank ab. Halte den Oberarm parallel zum Boden und strecke den Ellenbogen – Kurzhantel nach hinten schieben bis der Arm vollständig gestreckt ist. Langsam zurückführen.' },
  // Core (neu)
  { id:'e53', name:'Ab Rollout',               cat:'Core',    eq:'Körpergewicht', muscles:['Bauch','Core','Schulter'],               riskParts:['Rücken'],                desc:'Knie auf dem Boden, Rollrad in den Händen vor dir. Rolle langsam nach vorne bis der Körper fast waagerecht ist – Bauch und Rücken unter Spannung halten. Durch Bauchkraft wieder zurückrollen. Eine der anspruchsvollsten Core-Übungen.' },
  { id:'e54', name:'Side Plank',               cat:'Core',    eq:'Körpergewicht', muscles:['Seitliche Bauchmuskulatur','Hüfte'],     riskParts:['Rücken','Schulter'],     trackingType:'timed', desc:'Stütze dich seitlich auf einem Unterarm ab, Körper bildet eine gerade Linie von Kopf bis Fuß. Hüfte bleibt angehoben – nicht absacken lassen. Auf beiden Seiten separat ausführen. Stärkt seitliche Rumpfmuskulatur und Hüftstabilisatoren.' },
  // Cardio (neu)
  { id:'e55', name:'Ellipsentrainer',          cat:'Cardio',  eq:'Maschine',      muscles:['Gesamt'],                               riskParts:[],                        desc:'Ausdauergerät mit elliptischer Gleitbewegung, die Laufen simuliert ohne Gelenkbelastung. Widerstand und Tempo anpassen. Ideal für gelenkschonendes Cardio oder als Warm-up vor dem Krafttraining.' },
  { id:'e56', name:'Burpees',                  cat:'Cardio',  eq:'Keine',         muscles:['Gesamt'],                               riskParts:['Rücken','Schulter','Knie'], desc:'Aus dem Stand in die Kniebeuge, Hände auf den Boden, Beine nach hinten springen in die Liegestütz-Position, Liegestütz ausführen, Beine wieder heranziehen, aufspringen. Sehr intensiv – maximaler Kalorienverbrauch.' },
];
...
// TRACKING TYPES
// ============================================================
const TIMED_EXERCISE_IDS = new Set(['e33','e54']); // Plank, Side Plank
...
const MORE_VIEWS = ['progress', 'library', 'injuries', 'settings'];
